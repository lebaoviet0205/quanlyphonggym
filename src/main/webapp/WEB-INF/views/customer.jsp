        ...
        <div class="content">
            ...
            <div class="table-container">
            	<div class="table-header">
            		...
            		<form action="search-customer.htm" method="post" class="search-bar">
            			<span>Tìm kiếm</span>
            	...
            	<table class="table">
            		...
            		<tbody>	
            			<c:forEach var="p" items="${listCustomers}" begin="0" end="${listCustomers.size()}" varStatus="status">
						  	<tr>
	            				...
	            				<td>${p.getSDT()}</td>
	            				<td><a href="list-card.htm?id=${p.getMaKH()}"><i class="bi bi-wallet center"></i></a></td>
	            				<td><a href="edit-customer.htm?id=${p.getMaKH()}"><i class="bi bi-pencil-fill center"></i></a></td>
	            			</tr>          				
            			</c:forEach>
            		</tbody>
            	</table>
