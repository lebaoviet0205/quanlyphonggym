...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="table-container">
            	...
            	<div class="btns-container">
            		<button class="insert-btn">Thêm</button>
            	</div>
            	<table class="table">
            		<thead>
            			<tr>
            ...
            <div class="confirm-dialog hide" id="add-dialog">
            	<div>
            		<h3>Xác nhận thêm thẻ</h3>
	            	<p>Bạn có muốn thêm thẻ?</p>
	            	<div>
	            		<button class="secondary-btn close-dialog">Hủy</button>
	            		<a href="add-card.htm?id=${id}" class="primary-btn">Thêm</a>
	            	</div>
            	</div>
            </div>
		...
		<script>
			...
			const confirmDialog = document.querySelector("#add-dialog");
			...
			closeDialogBtn.addEventListener("click", handleShowDialog);
			insertBtn.addEventListener("click", handleShowDialog);
