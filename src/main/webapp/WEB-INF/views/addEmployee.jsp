    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
			...
			<div class="form-container">
				...
				<form:form class="form-employee" action="add-employee.htm" method="post" modelAttribute="nhanVien" enctype="multipart/form-data">
					...
					<input type="submit" value="Tiếp theo" style="grid-area: submit">
				</form:form>
			</div>
