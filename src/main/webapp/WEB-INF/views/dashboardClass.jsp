        ...
        <div class="content">
            ...
            <div class="table-container">
            	<div class="table-header">
            		<h2 class="title">Lớp dịch vụ</h2>
            		<form action="search-class.htm" method="post" class="search-bar">
            			<span>Tìm kiếm</span>
            			<input type="text" name="search" placeholder="Tên lớp..." value="${search}">
            			<button style="border: none; outline: none;"><i class="bi bi-search"></i></button>
            		</form>
            	</div>
            	<div class="btns-container">
            		<a class="insert-btn" href="new-class.htm">Thêm</a>
            	</div>
            	
            	<table class="table">
            		<thead>
            			<tr>
            				<th class="ta-start">Mã lớp</th>
            				<th class="ta-start">Tên lớp</th>
            		...
            		<tbody>
            			<c:forEach var="p" items="${listLop}" begin="0" end="${listLop.size()}" varStatus="status">
						  	<tr>
	            				<td><p class="code" title="${p.getMaLop()}">${p.getMaLop()}</p></td>
            					<td>${p.getTenLop()}</td>
            					<td ><a href="edit-class.htm?id=${p.getMaLop()}" style="display: block; width: 75px"><i class="bi bi-pencil-fill center"></i></a></td>
	            			</tr>          				
            			</c:forEach>
            		</tbody>
            	</table>
